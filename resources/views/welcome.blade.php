...
<?php }?>
    ...
    <li class="filter" data-filter="#{{$v_category->slug}}">{{$v_category->name}}<span class="badge">{{$category->count()}}</span></li>
                                           <?php  } ?>
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            <ul id="menu-pricing" class="menu-price">
                                ...
                                <li class="item" id="{{$item->category->slug}}">
                                    <a href="#">
     <img src="{{asset('uploads/item/'.$item->image)}}" class="img-responsive" alt="Food" style="width:569px;  height: 300px;">
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="copyright text-center">
                            <p>
                                &copy; Copyright, 2018 <a href="#">Mama kitchen</a> Developed by md al amin<a href="http://themewagon.com/"  target="_blank"></a>
                            </p>
                        </div>
                    </div>
                </div>
