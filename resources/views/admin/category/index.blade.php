...
@section('content')
 ...
 <h4 style="margin-bottom: 20px;margin-left: 17px;"><a href="{{route('category.create')}}" class="btn btn-info">Add Category</a></h4>
        ...
        <table id="table" class="table table-striped table-bordered"  style="width:100%" cellspacing="0">
                      <thead class="text-primary" style="width:100%">
                        ...
                        <th width="180px;">Create_at</th>
                        <th width="180px;">Update_at</th>
...
<button type="button" class="btn btn-info btn-sm" disabled=""><a href="{{route('category.edit',$category->id)}}"><i class="material-icons">mode_edit</i></a></button>
